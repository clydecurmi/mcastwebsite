<?php
  ...
  if(isset($_POST['register']))
  {
    ...
    if($idnum!='' && $fullname!='' && $email!='' && $locality!='' && $institute!='' && $course!='' && $form!='')
    {

    

    $sql = "INSERT INTO newapp(idnum, fullname, emailadd, institute, course, appform, Locality) VALUES('$idnum', '$fullname', '$email', '$institute', '$course', '$form', '$locality')";
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST" name="register" action="">
                ...
                <div class="form-group">
                  <input type="text" name="locality" class="form-control form-control-lg" id="email" placeholder="Locality">
                </div>
                <div class="form-group">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Thanks for applying to MCAST <a href="HomePage.html" class="text-primary">Home</a>
                </div>
              </form>
            </div>
          </div>
